...
| Mod | Version | Jar |
| --- | --- | --- |
| Animal Pens | 2.4.3 | `animal_pen-neoforge-26.1-2.4.3.jar` |
| Apotheosis | 26.1.2-9.0.2 | `Apotheosis-26.1.2-9.0.2.jar` |
| Apothic Attributes | 26.1.2-3.0.1 | `ApothicAttributes-26.1.2-3.0.1.jar` |
...
| Curios API (Forge/NeoForge) | beta.2+26.1.2 | `curios-neoforge-15.0.0-beta.2+26.1.2.jar` |
...
| Nyctography | 26.1.2.3 | `Nyctography-neoforge-MC26.1.2-26.1.2.3.jar` |
...
| Runelic | 26.1.2.3 | `Runelic-neoforge-MC26.1.2-26.1.2.3.jar` |
